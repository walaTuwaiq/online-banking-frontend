        ...
        <div className='container-chat'>
            ...
            <div className='body-chat'>
                <ScrollToBottom className="scroll-container">
                    {
                        // console.log(allMessages.length > 0,"all messages in client page")
                    }
                    {
                        allMessages.length>0 && allMessages.map((elem,index)=>{
                            return <div
                                    key={index}
            ...
            <div className='footer-chat'>
                ...
                <button onClick={()=>{sendMessage()}}>SEND &rarr;</button>
            </div>
        </div>
    )
}
