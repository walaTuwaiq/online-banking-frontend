        ...
        <div className='body-about-us'>
            ...
            <div className='cards-container'>
                <div className='about-card'>
                    ...
                    <p>
                    Founded in 1996, Alfaiadh Bank, Deeply rooted in Islamic banking principles, The Sharia compliant banking group is instrumental in bridging the gap between modern financial demands and Sharia intrinsic values, whilst spearheading numerous industry standards and development.
                    </p>
                </div>
                <hr className='hr-about'/>
                <div className='about-card'>
                    <p>
                    Alfaiadh bank’s vision is to be a premier financial and banking service provider locally and regionally.
                ...
                <div className='google-map'>
                    {
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27368.868341114012!2d41.01730140345901!3d30.967453025000342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x156c0dc453c5529b%3A0x857f510db855784c!2sAl%20Rajhi%20Bank!5e0!3m2!1sen!2ssa!4v1641045502895!5m2!1sen!2ssa" width="600" height="450" loading="lazy"></iframe>
                        :

                        <button className='btn-google' onClick={()=>{setToggle(true)}}>Our Location &darr;</button>
